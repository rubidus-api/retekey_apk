...
| **두벌식** | 표준 한글 전체 자판 |
| **QWERTY** | 영문 |
| **드보락** | 영문. 홈 행은 정확히 지키고, w·v·z는 맨 윗줄 끝에 둔다. 격자의 서른 칸에 드보락 본래의 7/10/9 행과 Shift·백스페이스·엔터·마침표가 함께 들어가지 않기 때문이다 |
| **천지인** | 12키. ㅣ ㆍ ㅡ 로 모음을 만들고, 자음 키는 누를 때마다 묶음 안을 돈다(ㄱ → ㅋ → ㄲ) |
