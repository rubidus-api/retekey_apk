...
final class HardwareLayoutTables {
    ...
    static {
        ...
        // Thai Pattachote (KBDTH1), both halves, from Microsoft's own table. Thai has no case, so
        // the "shifted" column is the layout's second set of characters rather than capitals —
        // the same pairs the soft page offers as an up-flick.
        register(KeyboardLayoutId.TH_PATTACHOTE, new String[] {
            "hardware.key.q|\u0E47|\u0E4A",
            "hardware.key.w|\u0E15|\u0E24",
            "hardware.key.e|\u0E22|\u0E46",
            "hardware.key.r|\u0E2D|\u0E0D",
            ...
            "hardware.key.o|\u0E27|\u0E16",
            "hardware.key.p|\u0E41|\u0E12",
            "hardware.keycode.71|\u0E43|\u0E2F",
            "hardware.keycode.72|\u0E0C|\u0E26",
            "hardware.key.a|\u0E49|\u0E4B",
            "hardware.key.s|\u0E17|\u0E18",
            "hardware.key.d|\u0E07|\u0E33",
            "hardware.key.f|\u0E01|\u0E13",
            ...
            "hardware.key.k|\u0E19|\u0E0A",
            "hardware.key.l|\u0E40|\u0E42",
            "hardware.keycode.74|\u0E44|\u0E06",
            "hardware.keycode.75|\u0E02|\u0E11",
            "hardware.key.z|\u0E1A|\u0E0E",
            "hardware.key.x|\u0E1B|\u0E0F",
            "hardware.key.c|\u0E25|\u0E10",
            "hardware.key.v|\u0E2B|\u0E20",
            ...
            "hardware.key.n|\u0E04|\u0E28",
            "hardware.key.m|\u0E2A|\u0E2E",
            "hardware.keycode.55|\u0E30|\u0E1F",
            "hardware.keycode.56|\u0E08|\u0E09",
            "hardware.keycode.76|\u0E1E|\u0E2C",
        });
