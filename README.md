...
**ReteKey v0.1.191** (latest release) download — [apk (Android 9+)](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.191/retekey-0.1.191.apk) · [legacy apk (Android 4.0+)](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.191/retekey-0.1.191-legacy.apk)
...
Current release: **v0.1.191** —
[retekey-0.1.191.apk](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.191/retekey-0.1.191.apk) (676 KB; the Android 4.0 build is 549 KB)
