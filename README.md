...
**ReteKey v0.1.148** (latest release) download — [apk (Android 9+)](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.148/retekey-0.1.148.apk) · [legacy apk (Android 4.0+)](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.148/retekey-0.1.148-legacy.apk)
...
Current release: **v0.1.148** —
[retekey-0.1.148.apk](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.148/retekey-0.1.148.apk) (617 KB; the Android 4.0 build is 516 KB)
