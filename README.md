...
**ReteKey v0.1.147** (latest release) download — [apk (Android 9+)](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.147/retekey-0.1.147.apk) · [legacy apk (Android 4.0+)](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.147/retekey-0.1.147-legacy.apk)
...
Current release: **v0.1.147** —
[retekey-0.1.147.apk](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.147/retekey-0.1.147.apk) (617 KB; the Android 4.0 build is 516 KB)
