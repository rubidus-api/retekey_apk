...
**ReteKey v0.1.149** (latest release) download — [apk (Android 9+)](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.149/retekey-0.1.149.apk) · [legacy apk (Android 4.0+)](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.149/retekey-0.1.149-legacy.apk)
...
Current release: **v0.1.149** —
[retekey-0.1.149.apk](https://github.com/rubidus-api/retekey_apk/releases/download/v0.1.149/retekey-0.1.149.apk) (617 KB; the Android 4.0 build is 517 KB)
